...
//    }
    ...
    public List<EventsEntity> findAllEventsByLocaleAndGameIdAndSportId(String locale, Long gameId, Long sportId){
        return eventsEntityRepository.findAllEventsByLocaleAndGameIdAndSportId(locale, gameId, sportId);
    }
